...
const Info: React.FC<{icon:React.ReactNode;label:string;value:string}> = ({icon,label,value}) => <div className="border border-[#333] bg-[#080808] p-2"><div className="flex items-center gap-1 text-[#F27D26] text-[9px] font-bold">{React.cloneElement(icon as React.ReactElement, {className:'w-3 h-3'})}{label}</div><div className="text-[10px] text-white mt-1 leading-relaxed">{value}</div></div>;
